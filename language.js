...
dotsContent.addEventListener('change', (event) => {
  ...
  if(selectedOption == "Spanish"){
    topNav.innerHTML = `<div class="yt-menu"> <button class="navicons" id="burguer-menu"><a href=""><img src="img/Navbar/3 bars.PNG" class="burguer-menu"/></a></button><button id="yt-icon"><a href="./index.html"><img src="img/Navbar/youtube icon.PNG" class=> </a></button></div><div class="nav-center"><div class="Searchbar"><input type="text" placeholder="Buscar" id="Searchbar" /><button id="Searchbutton"><a href="#"><img src="img/Navbar/search.PNG" /></a></button></div><button class="navicons" id="Navmic"><a href=""> <img src="img/Navbar/mic.PNG" /></a></button></div><div class="nav-right-side"><button id="dots"><img src="img/Navbar/settings.PNG" class="settings-pic"/></button><select  id="dots-content"><label for="">Idioma</label><option  value="English" >Inglés</option><option  value="Spanish">Español</option></select ><button id="sign-in" style="width: 150px"><a href=""><img src="img/Navbar/sign in.PNG" class="sign-in-pic" /><label id="sign-in-label">Iniciar Sesión</label></a></button> </div></div>`;    
    ...
    header.innerHTML = `<div class="yt-menu"> <button class="navicons" id="burguer-menu"><a href=""><img src="img/Navbar/3 bars.PNG" class="burguer-menu"/></a></button><button id="yt-icon"><a href="./index.html"><img src="img/Navbar/youtube icon.PNG" class=> </a></button></div><div class="nav-center"><div class="Searchbar"><input type="text" placeholder="Search" id="Searchbar" /><button id="Searchbutton"><a href="#"><img src="img/Navbar/search.PNG" /></a></button></div><button class="navicons" id="Navmic"><a href=""> <img src="img/Navbar/mic.PNG" /></a></button></div><div class="nav-right-side"><button id="dots"><img src="img/Navbar/settings.PNG" class="settings-pic"/></button><select  id="dots-content"><label for="">Language</label><option  value="English" >Inglés</option><option  value="Spanish">Español</option></select ><button id="sign-in" style="width: 150px"><a href=""><img src="img/Navbar/sign in.PNG" class="sign-in-pic" /><label id="sign-in-label">Sign in</label></a></button> </div></div>`;
